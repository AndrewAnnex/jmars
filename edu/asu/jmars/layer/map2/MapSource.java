...
public interface MapSource extends Serializable {
	 ...
	 * @param mapTile Fetch parameters.
	 * @return Image data or <code>null</null> if the image data could not be
	 * retrieved. In this case the mapTile parameter will contain exceptions
	 * and messages corresponding to failure.
	 * @throws RetryableException if the source exception points to a request
	 *         that may be retried.
	 * @throws NonRetryableException if the source exception points to a request
	 *         that may be not retried.
	 */
